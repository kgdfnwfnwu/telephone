...
public class IpMessageProtocol {
	...
	public IpMessageProtocol(String senderName, String senderHost, int commandNo,String additionalSection) {
		super();
		
		this.version = "1";
		this.packetNo = getSeconds();
		this.senderName = NetThreadHelper.newInstance().getSelfName();
